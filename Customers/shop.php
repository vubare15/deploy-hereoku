...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is a toy for teenagers,Buy Now!</h3></center>
        </div>
...
$conn=mysqli_connect("pei17y9c5bpuh987.chr7pe7iynqr.eu-west-1.rds.amazonaws.com","ol9srihjuo6pu5v9","ahn9alyahvgq4vcf");
mysqli_select_db($conn,"btkpxbu07ua2q46v");
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<img src='../Admin/item_images/".$query2['item_image']."' class='img img-thumbnail'  style='width:350px;height:250px;' />
					</a>
